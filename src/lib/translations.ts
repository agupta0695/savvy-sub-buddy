...
export const translations: Record<Language, Translations> = {
  ...
  te: {
    // Telugu translations - using English as base (can be translated later)
    // App Name
    appName: 'SubSentry',
    tagline: 'Never forget a Subscription',
    ...
    annualCost: 'Annual Cost',
    activeSubscriptions: 'Active Subscriptions',
    renewingSoon: 'Subscriptions Renewing Soon',
    view: 'View',
    noSubscriptions: 'No subscriptions yet. Click + to add one!',
    renews: 'Renews',
    daysLeft: 'days left',
  ...
  gu: {
    // Gujarati translations - using English as base (can be translated later)
    // App Name
    appName: 'SubSentry',
    tagline: 'Never forget a Subscription',
  ...
  ta: {
    // Tamil translations - using English as base (can be translated later)
    // App Name
    appName: 'SubSentry',
    tagline: 'Never forget a Subscription',
